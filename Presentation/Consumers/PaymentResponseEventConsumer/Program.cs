...
IHost host = Host.CreateDefaultBuilder(args)
    ...
    {
        services.AddScoped<IEventConsumer, PaymentResponseEventConsumer.PaymentResponseEventConsumer>();
        services.AddHostedService<PaymentResponseEventConsumerHostedService>();
